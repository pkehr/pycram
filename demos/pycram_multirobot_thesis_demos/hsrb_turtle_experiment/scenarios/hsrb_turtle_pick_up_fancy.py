...
def turtle_drive_to_table_two():
    # TODO: Turn turtlebot 180 degrees
...
def demo():
    ...
    Navigate
    Robot:      Turtlebot
    From:       turtle_starting_pose
    To:         Table#1 
    '''
    with real_robot(robot_turtle):
        turtle_drive_to_table_one()
