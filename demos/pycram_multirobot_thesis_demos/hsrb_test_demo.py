...
from pycram.datastructures.enums import WorldMode, ExecutionType
from pycram.datastructures.pose import Pose
from pycram.process_module import simulated_robot, with_simulated_robot, ProcessModule, semi_real_robot
...
execution_type = semi_real_robot
...
with execution_type:
    ParkArmsActionDescription([Arms.LEFT]).resolve().perform()
