...
class ActionDesignatorDescription(DesignatorDescription, Language):
    ...
    class Action:
        ...
        def __post_init__(self):
            ...
            self.robot_torso_height = RobotManager.active_robot.get_joint_position(RobotDescription.current_robot_description.torso_joint)
    ...
    def __init__(self, resolver=None, ontology_concept_holders: Optional[List[OntologyConceptHolder]] = None):
        ...
        self.soma = False #OntologyManager().soma
